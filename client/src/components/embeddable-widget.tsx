...
function EmbeddableWidget({ config }: { config: WidgetConfig }) {
  ...
  return (
    <div className={getPositionStyles()}>
      <motion.div
        className="w-80 h-96 rounded-lg shadow-xl border border-gray-200 flex flex-col relative"
        style={{
          position: 'relative',
          zIndex: 1000,
      ...
      >
        ...
        <div 
          ...
          onDrop={handleDrop}
        >
          {/* Solid white background for messages area */}
          <div 
        ...
        {attachedFiles.length > 0 && (
          <div className="px-4 py-2 border-t border-gray-200 space-y-2 relative">
            {/* Solid white background for file preview area */}
            <div 
              className="absolute inset-0 bg-white"
              style={{
                backgroundColor: 'white',
        ...
        {/* Input */}
        <div className="p-4 border-t border-gray-200 relative" style={{
          position: 'relative',
          zIndex: 1002
        }}>
          {/* Solid white background for input area */}
          <div 
            className="absolute inset-0 bg-white"
            style={{
              backgroundColor: 'white',
